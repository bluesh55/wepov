...
ActiveRecord::Schema.define(version: 20151029143833) do
  ...
  add_index "comments", ["debate_id"], name: "index_comments_on_debate_id"
  ...
  add_index "points", ["debate_id"], name: "index_points_on_debate_id"
  ...
  add_index "reasons", ["point_id"], name: "index_reasons_on_point_id"
